...
def evaluate_densities(data, subscripts, parameters):
    ...
    target += jax.numpy.sum(jax.scipy.stats.norm.logpdf(data['y'], parameters['mu_ret'] + parameters['rho'] * parameters['v'][subscripts['t__8']] * parameters['s'][subscripts['t__9']], parameters['s'][subscripts['t__10']]))
