...
class RatParser(Parser):
    ...
    def _ifelse_(self):  # noqa
        ...
        self._define(["left", "predicate", "right"], [])
    ...
    def _variable_(self):  # noqa
        ...
        with self._optional():
            ...
            self._define(["arglist"], [])
        with self._optional():
            self._token("'")
            self.name_last_node("prime")

        self._define(["arglist", "constraints", "name", "prime"], [])
    ...
    def _literal_(self):  # noqa
        with self._group():
            with self._choice():
                ...
                with self._option():
                    self._integer_()
                self._error("expecting one of: " "<integer> <real> [-]?[0-9]+\\.[0-9]*" "[-]?[0-9]+\\.[0-9]*e[-+]?[0-9]+ [-]?\\d+")
        self.name_last_node("value")
    ...
    def _real_(self):  # noqa
        with self._choice():
            ...
            self._error("expecting one of: " "[-]?[0-9]+\\.[0-9]*" "[-]?[0-9]+\\.[0-9]*e[-+]?[0-9]+")
